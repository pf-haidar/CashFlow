...
internal class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "UseCases\\Expenses\\Reports\\Pdf\\Logo", "ProfilePhoto.png");

        row.Cells[0].AddImage(pathFile);

        row.Cells[1].AddParagraph("Olá, Pedro Filho");
